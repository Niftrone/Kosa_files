...
public class Engineer extends Employee{
	...
	public Engineer(int empno,String name, double salary, MyDate birthDate, MyDate hireDate,  String tech, int bonus) {
	...
	public String toString() {
		return "Engineer : "+super.toString() + " tech=" + tech + ", bonus=" + bonus + "]";
	}
