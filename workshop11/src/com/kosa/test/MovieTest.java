...
import com.kosa.service.MovieMgr;
	...
	public static void main(String[] args) {
		...
		while(flag) {
			...
			case 3:
				...
				mvName = sc.next();
				System.out.println(Arrays.toString(mvManager.search(mvName, "title")));
				break;
			case 4:
				System.out.print("찾고자하는 장르를 입력하세요 : ");
				mvGre = sc.next();
				System.out.println(Arrays.toString(mvManager.search(mvGre, "genre" )));
				break;
			case 5:
